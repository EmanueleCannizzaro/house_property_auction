...
class IdealistaAPI():
    ...
    def read_configuration(filename:str):
        with open(filename, 'r') as f:
            ...
            print(configuration['api.idealista.it'].keys())
            return configuration

    @staticmethod
    def get_property_type(configuration):
        url = configuration['api.idealista.it']['property_type']['url']
        assert(url == "https://api.idealista.it/rest/standard-v1/getImmobiliType/")
        method = configuration['api.idealista.it']['property_type']['method']
        headers = configuration['api.idealista.it']['property_type']['headers']
        payload = configuration['api.idealista.it']['property_type']['payload']
