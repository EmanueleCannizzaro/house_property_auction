...
@traced
@logged
class EngelvoelkersSearchSpider(SeleniumSearchSpider):
    name = 'engelvoelkers'
    allowed_domains = ['https://www.gate-away.com/']
    start_urls = [
    ...
    URL = 'https://www.engelvoelkers.com/en/search/?q=&startIndex=0&businessArea=residential&sortOrder=DESC&sortField=sortPrice&pageSize=18&facets=bsnssr%3Aresidential%3Bcntry%3Aitaly%3Btyp%3Abuy%3B'
    LOGIN_URL = ''
    NEXT_PAGE_URL = 'https://www.engelvoelkers.com/en/search/?q=&startIndex={16 + 18 * ix}&businessArea=residential&sortOrder=DESC&sortField=sortPrice&pageSize=18&facets=bsnssr%3Aresidential%3Bcntry%3Aitaly%3Btyp%3Abuy%3B'
