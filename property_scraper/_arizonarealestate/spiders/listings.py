...
from property_scraper.arizonarealestate.items import ArizonaRealEstateItem
...
class ListingsSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        for listing in gallery:
            item = ItemLoader(item=ArizonaRealEstateItem(), response=response, selector=listing)
            item.add_xpath(
