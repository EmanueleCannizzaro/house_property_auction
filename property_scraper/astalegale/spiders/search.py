...
@traced
@logged
class AstaLegaleSearchSpider(SeleniumSearchSpider):
    name = 'astalegale'
    allowed_domains = ['www.astalegale.net']
    start_urls = ['https://www.astalegale.net/']

    URL = ''
    LOGIN_URL = 'https://www.astalegale.net/Account/Login'
    WEBSITE = 'astalegale'
    LOGIN_XPATH = {
    ...
    SEARCH_XPATH = {
        ...
        'number_of_results_per_page' : '//article[@class="cc-item-list"]',
