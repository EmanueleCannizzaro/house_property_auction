...
@traced
@logged
class LionardSearchSpider(SeleniumSearchSpider):
    name = 'lionard'
    allowed_domains = ['www.lionard.com/']
    start_urls = [
        'https://www.lionard.com/find/property/italy/all/all'
    ]
    '''
    ...
    URL = 'https://www.lionard.com/find/property/italy/all/all'
    LOGIN_URL = ''
    NEXT_PAGE_URL = 'https://www.lionard.com/find/property/italy/all/all?pagina={}'
    WEBSITE = 'lionard'
    LOGIN_XPATH = {
