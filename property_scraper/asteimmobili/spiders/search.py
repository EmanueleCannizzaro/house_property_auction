...
@traced
@logged
class AsteImmobiliSearchSpider(SeleniumSearchSpider):
    name = 'asteimmobili'
    allowed_domains = ['www.asteimmobili.it']
    start_urls = [
		'https://www.asteimmobili.it/Immobili/Search'
	]

    ''' It resembles very strongly astalegale. '''
    URL = 'https://www.asteimmobili.it/Immobili/Search'
    LOGIN_URL = ''
    #NEXT_PAGE_URL = ''
    WEBSITE = 'asteimmobili'
    LOGIN_XPATH = {
