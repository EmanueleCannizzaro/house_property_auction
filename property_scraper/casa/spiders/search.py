...
@traced
@logged
class CasaSearchSpider(SeleniumSearchSpider):
    name = 'casa'
    allowed_domains = ['www.casa.it']
    start_urls = [
        'https://www.casa.it/vendita/residenziale/ravenna-provincia/'
    ]
    '''
    ...
    URL = 'https://www.casa.it/vendita/residenziale/ravenna-provincia/'
    LOGIN_URL = ''
    NEXT_PAGE_URL = 'https://www.casa.it/vendita/residenziale/ravenna-provincia?page={}'
    WEBSITE = 'casa'
    LOGIN_XPATH = {
        #'advertisement': '//button[@class="remodal-close"]',
        'cookie' : '//button[@id="onetrust-accept-btn-handler"][contains(text(), "Accetto tutto")]',
    ...
    SEARCH_XPATH = {
        ...
        'number_of_results' : '//h1[@class="heading__h1 tp-w--l c-txt--secondary"][contains(text(), " Case in vendita in")]',
        'number_of_results_per_page' : '//article[@class="srp-card mt--m platinum no-poi highlight"]',
