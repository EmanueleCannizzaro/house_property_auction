...
from property_scraper.idealista.items import RealEstateItem, HouseItem, RoomItem, OfficeItem, LandItem, GarageItem, CommercialItem,\
    StoreRoomItem, BuildingItem, TerritorialEntity
# Django model imports
from property_scraper.houses.models import Date, Price, RealEstate, House, Room, Office, Land, Garage, Commercial, StoreRoom, Building,\
    TerritorialEntity
