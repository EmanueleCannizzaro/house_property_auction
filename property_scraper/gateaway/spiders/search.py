...
@traced
@logged
class GateAwaySearchSpider(SeleniumSearchSpider):
    name = 'gateaway'
    ...
    URL = 'https://www.gate-away.com/properties?currency=EUR'
    LOGIN_URL = ''
    NEXT_PAGE_URL = 'https://www.gate-away.com/properties?currency=EUR&pag={}'
    WEBSITE = 'gateaway'
    LOGIN_XPATH = {
