...
from property_scraper.auctionhouse.items import AuctionHouseSearchPropertyItem, AuctionHouseSearchPropertyModel


@traced
@logged
class AuctionHouseSearchPropertySpider(Spider):
    name = 'auctionhouse_searchproperty'
    WEBSITE = name.split('_')[0]
    allowed_domains = ['www.auctionhouse.co.uk']
    start_urls = [
        'https://www.auctionhouse.co.uk/auction/future-auction-dates'
    ]
