...
from property_scraper.auctionhouse.items import AuctionHousePropertyItem, AuctionHousePropertyModel


@traced
@logged
class AuctionHousePropertySpider(Spider):
    name = 'auctionhouse_property'
    WEBSITE = name.split('_')[0]
    
    allowed_domains = ['localhost:8000', 'www.auctionhouse.co.uk']
