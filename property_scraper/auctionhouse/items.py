...
from property_scraper import AUCTIONHOUSE_URL_ROOTNAME


def create_url(url):
    return urljoin(AUCTIONHOUSE_URL_ROOTNAME, url)
...
class AuctionHouseSearchPropertyItem(Item):
    items = {
        'css': {
        },
        'xpath': {
...
class AuctionHouseSearchPropertyModel(BaseModel):
    ref: str
    url: str
    town: str
    county: str
...
class AuctionHousePropertyItem(Item):
    items = {
        'css': {
        },
        'xpath': {
...
class AuctionHousePropertyModel(BaseModel):
    lawyer: str
