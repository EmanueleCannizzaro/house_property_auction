...
@traced
@logged
class PortaleAsteSearchSpider(SeleniumSearchSpider):
    name = 'portaleaste'
    allowed_domains = ['www.portaleaste.com']
    start_urls = ['https://www.portaleaste.com/Immobili/Search']

    URL = 'https://www.portaleaste.com/Immobili/Search'
    LOGIN_URL = ''
    WEBSITE = 'portaleaste'
    LOGIN_XPATH = {
