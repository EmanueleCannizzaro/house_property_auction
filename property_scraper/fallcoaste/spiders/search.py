...
@traced
@logged
class FallcoasteSearchSpider(SeleniumSearchSpider):
    name = 'fallcoaste'
    allowed_domains = ['www.fallcoaste.it']
    start_urls = [
        'https://www.fallcoaste.it/ricerca.html?filter=libera%7Cimmobile%5Emacro%7C527%5Ecat0%7C528%5Einput_categoria%7C%3Cstrong%3EBeni%20Immobili%3C%2Fstrong%3E%3A%20Immobile%20residenziale%5Eubicazione_dst%7C50%5Estato%7C1',
        'https://www.fallcoaste.it/ricerca.html?filter=libera%7Cimmobile%5Emacro%7C527%5Ecat0%7C528%5Einput_categoria%7C%3Cstrong%3EBeni%20Immobili%3C%2Fstrong%3E%3A%20Immobile%20residenziale%5Eubicazione_dst%7C50%5Estato%7C2',
        'https://www.fallcoaste.it/ricerca.html?filter=libera%7Cimmobile%5Emacro%7C527%5Ecat0%7C528%5Einput_categoria%7C%3Cstrong%3EBeni%20Immobili%3C%2Fstrong%3E%3A%20Immobile%20residenziale%5Eubicazione_dst%7C50%5Estato%7C3'
    ]

    URL = 'https://www.fallcoaste.it/ricerca.html?filter=libera%7Cimmobile%5Emacro%7C527%5Ecat0%7C528%5Einput_categoria%7C%3Cstrong%3EBeni%20Immobili%3C%2Fstrong%3E%3A%20Immobile%20residenziale%5Eubicazione_dst%7C50%5Estato%7C{}'
    PERIOD = {
        'future': 1, # Aperte
        #'past': 0, 
        'past_sold': 2, # Chiuse e aggiudicate
        'past_non-sold': 3, # Chiuse e aggiudicate
    }
    LOGIN_URL = ''
    WEBSITE = 'fallcoaste'
    LOGIN_XPATH = {
    ...
    SEARCH_XPATH = {
        ...
        'number_of_results' : '//span[@class="total-results"]/strong',
        'number_of_results_per_page' : '//article[@class="hover-block auction horizontal-auction fallcoaste"]',
        'scroll' : '//a[@class="arrow right"][contains(text(), ">")]'
    }
    SEARCH_SELECT = {
