...
@traced
@logged
class LegalmenteSearchSpider(SeleniumSearchSpider):
    name = 'legalmente'
    allowed_domains = ['www.legalmente.net']
    start_urls = [
        'https://www.legalmente.net/ricerca.do?rds26=06-05-2023&rmo=D&rds26_op=A'
    ]

    URL = 'https://www.legalmente.net/ricerca.do?rds26=06-05-2023&rmo=D&rds26_op=A'
    LOGIN_URL = ''
    WEBSITE = 'legalmente'
    LOGIN_XPATH = {
    ...
    SEARCH_XPATH = {
        ...
        'cookie' : '//button[@class="cdbtn cookie cdbar-cookie-accept"][contains(text(), "OK")]',
        'number_of_results' : '//div[@class="barra-right mappa"]/div',
        'number_of_results_per_page' : '//div[@class="item-risultato clearfix"]',
        'scroll' : '//ul[@class="pagination2"]/li/a[@class="prossima"]',
    }
    SEARCH_SELECT = {
    ...
    def get_number_of_results(element):
        return element.text.strip().split(' ')[1] #.replace('Avvisi: ', '')
